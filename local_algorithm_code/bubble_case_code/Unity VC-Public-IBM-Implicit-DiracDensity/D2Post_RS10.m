...
% x轴，正下方标签："time (s)"
xlabel('time (s)');
% y轴，左侧正中标签："Rising velocity (m/s)"
ylabel('Rising velocity (m/s)');
% 使用红色方框标记离散点：{(0.8，0.2266),(2.6，0.1230),(4.6，0.0406),(9,0.0305),(12.8,0.0510),(14.8,0.0159)}
% 定义离散点的坐标
discrete_points = [0.4,0.1586; 0.8, 0.2266; 2.6, 0.1230; 4.6, 0.0406; 9, 0.0305; 12.8, 0.0499; 14.8, 0.0159];
% 使用红色方框标记离散点
plot(discrete_points(:, 1), discrete_points(:, 2), 'rs');

plot(Time,Yc,'-k');hold on
% x轴，正下方标签："time (s)"
xlabel('time (s)');
% y轴，左侧正中标签："Center of mass (m)"
ylabel('Center of mass (m)');
% 使用红色方框标记离散点：{(0.8，0.2266),(2.6，0.1230),(4.6，0.0406),(9,0.0305),(12.8,0.0499),(14.8,0.0159)}
x_points = [0.4, 0.8, 2.6, 4.6, 9, 12.8, 14.8];
% 使用 interp1 函数查找对应的 y 值
y_points = interp1(Time, Yc, x_points);
yticks(0.5:0.2:1.5); 
plot(x_points, y_points, 'rs');
