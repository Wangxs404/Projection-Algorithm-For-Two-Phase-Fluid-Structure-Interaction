  load("F:\tsinghua\submitting\bubble\Va1-RisingBubble_IBM_10_DensityDirac-Y1.5-Mat\D2Data174000.mat");    % 续算时开启
  istep_max=ceil(20/dt);
  Res_Freq=50  ;  dat_Freq=1000; mat_Freq=2000;
