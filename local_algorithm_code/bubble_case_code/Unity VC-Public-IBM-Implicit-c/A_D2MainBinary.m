...
%==================================划分网格&时间步================================
Dim=1;
Lx=1*Dim    ;    Ly=2*Dim  ;         nx=128;    ny=256;
dt=5e-5     ;    istep_max=ceil(20/dt);  theta=90;  % 默认润湿角
...
Res_Freq=50  ;  dat_Freq=1000;  mat_Freq=10000;  Dynamic_Draw='ON'; % Debug设置
...
%==================================将数据存储至上级目录=============
name="RisingBubble_IBM_10_Finer";        % 在上级目录创建文件夹存储数据
